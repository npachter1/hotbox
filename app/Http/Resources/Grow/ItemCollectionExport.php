...
class ItemCollectionExport implements FromQuery, WithHeadings, WithCustomCsvSettings, WithMapping
{
    
    use Exportable;
    public function __construct(array $data){
        $this->data = $data;
        $this->schema = AppSchema::getSchema('item_schema');
        $this->headers = [
                'name'             => 'Name',
                'metrc_category.name'              => 'Category',
