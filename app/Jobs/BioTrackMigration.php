...
class BioTrackMigration implements ShouldQueue
{
    use Dispatchable, InteractsWithQueue, Queueable, SerializesModels;
    
    public $tries = 1;
    public $timeout = 3600; // you have 1 hour!
    protected $location;
    protected $user;
    protected $service;
    protected $metrcApi;
    ...
    public function handle(){
        ...
        if(($this->location = Location::find($this->user->location_id))==null) abort(422,'Couldnt access location data - aborting');    
