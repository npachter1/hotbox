...
class MetrcPackageAdjust extends MetrcBaseJob
{
    protected $quantity;
    protected $unitOfMeasure;
    protected $adjustmentDate;
    protected $adjustmentReason;
    protected $reasonNote;

    public function __construct($items, $user, $quantity, $unitOfMeasure, $adjustmentDate, $adjustmentReason, $reasonNote)
    {
    ...
    public function handle(MetrcPackageApi $api)
    {
        ...
        if (!$this->test_mode) {
            ...
            $http_code = $api->adjustItems($this->user, $jsonItems);
