...
class InventoryLog extends Eloquent
{
    ...
    protected $table = 'dispensary_inventory_logs';
	...
	protected $fillable = ['type','value','reason_code','notes'];
	protected $dates = ['reviewed_at','metrc_synced_at','created_at','updated_at','deleted_at'];
    protected $casts = [];
	...
	/*  suite this inventory belongs to */
