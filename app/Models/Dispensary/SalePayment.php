...
class SalePayment extends Eloquent
{
    ...
    protected $table = 'dispensary_sale_payments';
	...
	protected $fillable = ['payment_method','payment_method_unique_identifier','amount'];
	protected $dates = ['created_at','updated_at','deleted_at'];
    protected $casts = ['amount'=>'float','amount_owed'=>'float'];
    ...
    public static function _getSchema(){
        ...
        $schema = AppSchema::getSchema('salepayment_schema');
