...
class AuthSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('auth_locations')->insert([
            ...
            [
                'id'                => self::LOC_REC2_ID,
                'name'              => 'bGood Wash Park Med Dev Migrate',
                'is_demo'           => 1,
                'status'            => 'activated',
                'type'              => 'dispensary',
            ...
            [
                'id'                => self::LOC_QUINTEL_ID,
                'name'              => 'Quintel Test Grow',
                'is_demo'           => 1,
                'status'            => 'activated',
                'type'              => 'grow',
                'licensenum'        => '020_X0002',                            // super location works off the sandbox
                'thumb'             => null,
                'settings'          => json_encode((object)[
                    'communication_email'   => 'support@hotboxerp.com',
                    'communication_timezone'=> 'America/Denver',
        ...
        DB::table('users')->insert(
            [
                ...
                [ 'id' => self::USER_SBUDTENDER_ID, 'name' => 'Sandbox Budtender', 'email' => 'sbudtender@hotboxerp.com','type' => 'staff', 'location_id' => self::LOC_GROW_ID, 'password' => bcrypt('sbudtenderHotBox2019'), 'pincode' => '3333', 'status' => 'activated', 'created_at'=>'2018-01-01 00:00:01'],
                ...
                [ 'id' => self::USER_QUINTEL_ID, 'name' => 'Quintel Admin', 'email' => 'quintel@hotboxerp.com','type' => 'admin', 'location_id' => self::LOC_QUINTEL_ID, 'password' => bcrypt('$$Hotbox$$'), 'pincode' => '9999', 'status' => 'activated', 'created_at'=>'2018-01-01 00:00:01'],
        ...
        DB::table('auth_model_has_roles')->insert(
            [
                ...
                [ 'role_id' => self::ROLE_ADMINISTRATOR, 'model_uuid' => self::USER_QUINTEL_ID, 'model_type' => 'App\Models\Auth\User' ],
                [ 'role_id' => self::ROLE_RETAIL_ADMINISTRATOR, 'model_uuid' => self::USER_QUINTEL_ID, 'model_type' => 'App\Models\Auth\User' ],
                [ 'role_id' => self::ROLE_RETAIL_MANAGER, 'model_uuid' => self::USER_QUINTEL_ID, 'model_type' => 'App\Models\Auth\User' ],

                [ 'role_id' => self::ROLE_BUDTENDER, 'model_uuid' => self::USER_SBUDTENDER_ID, 'model_type' => 'App\Models\Auth\User' ],
        ...
        DB::table('auth_location_user')->insert(
            [
                ...
                [ 'user_id' => self::USER_SUPER_ID, 'auth_location_id' => self::LOC_QUINTEL_ID],
                ...
                [ 'user_id' => self::USER_QUINTEL_ID, 'auth_location_id' => self::LOC_QUINTEL_ID], // quintel has quintel.
