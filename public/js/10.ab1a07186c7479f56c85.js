...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    if (this.id) {
      _models_Plant__WEBPACK_IMPORTED_MODULE_0__["default"].find(this.id).then(function (response) {
        _this.item = new _models_Plant__WEBPACK_IMPORTED_MODULE_0__["default"](response).withDefaults(_this.schema);
      ...
      this.item = new _models_Plant__WEBPACK_IMPORTED_MODULE_0__["default"]().withDefaults(this.schema);
