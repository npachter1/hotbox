  ...
  methods: {
        ...
        if (result) {
          _this2.$swal.fire({
            ...
            if (result.value) {
              ...
              axios.post('/api/v1/admin/grow/plants/createPlantings', _this2.newItem).then(function (response) {
                _this2.$announcer({
                  status: 200,
                  data: {
                    message: 'Success'
    ...
    setSourcePlant: function setSourcePlant(id) {
      ...
      axios.get('/api/v1/admin/grow/plants/' + itemid).then(function (response) {
        ...
        _this3.newItem.source_plant_id = _this3.sourcePlant.id;
                  ...
                  _c("div", { staticClass: "form-group" }, [
                    _c(
                      ...
                      [
                        ...
                        _c(
                          "option",
                          { attrs: { value: "Untracked Vegetative" } },
                          [_vm._v("Untracked Vegetative")]
                        )
                      ]
                    ),
                    _vm._v(" "),
