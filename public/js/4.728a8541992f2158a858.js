  ...
  mounted: function mounted() {
    ...
    if (this.id) {
      _models_Package__WEBPACK_IMPORTED_MODULE_1__["default"].find(this.id).then(function (response) {
        _this.item = new _models_Package__WEBPACK_IMPORTED_MODULE_1__["default"](response).withDefaults(_this.schema);
      ...
      this.item = new _models_Package__WEBPACK_IMPORTED_MODULE_1__["default"]().withDefaults(this.schema);
                    ...
                    return _c(
                      ...
                      [
                        ...
                        formItem.type == "text" && formItem.name == "label"
                          ? _c("form-text", {
                              attrs: {
                                disabled: _vm.item.transfer_id != null,
                                hideLabel: true,
                                schema: formItem
                              },
                              model: {
