  ...
  mounted: function mounted() {
    ...
    if (this.id) {
      _models_PlantBatches__WEBPACK_IMPORTED_MODULE_1__["default"].find(this.id).then(function (response) {
        _this.item = new _models_PlantBatches__WEBPACK_IMPORTED_MODULE_1__["default"](response).withDefaults(_this.schema);
      ...
      this.item = new _models_PlantBatches__WEBPACK_IMPORTED_MODULE_1__["default"]().withDefaults(this.schema);
