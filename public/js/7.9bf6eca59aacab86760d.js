...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    remainingWeight: function remainingWeight() {
      ...
      var totalWeight = this["package"].quantity;
      var usedWeight = 0;
          ...
          ? _c("div", { staticClass: "form-row" }, [
              ...
              _c("div", { staticClass: "col-3" }, [
                ...
                _c("div", { staticClass: "form-group" }, [
                  _vm._v(
                    "\n                    " +
                      _vm._s(_vm.package.quantity) +
                      " " +
                      _vm._s(_vm.package.unit_of_measure) +
                      "\n                "
                  )
                ])
              ]),
              ...
              _c("div", { staticClass: "col-3" }, [
                ...
                _c(
                  "div",
                  { staticClass: "form-group", staticStyle: { color: "red" } },
                  [
                    _vm._v(
                      "\n                    " +
                        ...
                        " " +
                        _vm._s(
                          _vm.newItem.package_uom ? _vm.newItem.package_uom : ""
                        ) +
                        "\n                "
                    )
                  ]
              ...
              ? _c("div", { staticClass: "col-6" }, [
                  ...
                  _c("div", { staticClass: "form-group" }, [
                    _c("input", {
                      ...
                      class: {
                        input: true,
                        "text-danger": _vm.errors.has("patient_license_number")
                      },
                      attrs: {
                  ...
                  _vm.newItem.item_sections[n - 1]
                    ? _c("div", { staticClass: "form-group" }, [
                        _c(
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.newItem.item_sections[n - 1].item_id,
                                expression: "newItem.item_sections[n-1].item_id"
                              },
                              {
                                name: "validate",
                                rawName: "v-validate",
                          ...
                          _vm._l(_vm.schema.form.product_id.values, function(
                            item
                          ) {
                            return _c(
                              "option",
                          ...
                          directives: [
                            {
                              ...
                              rawName: "v-model",
                              value:
                                _vm.newItem.item_sections[n - 1].product_weight,
                              expression:
                          ...
                          directives: [
                            {
                              ...
                              rawName: "v-model",
                              value:
                                _vm.newItem.item_sections[n - 1].product_count,
                              expression:
                    ...
                    ? _c(
                        ...
                        [
                          _c("input", {
                            ...
                            staticClass: "form-control",
                            attrs: { type: "text", name: "package_weight" },
                            domProps: {
                              value:
                                _vm.newItem.item_sections[n - 1].package_weights
                            },
                            on: {
                              change: function($event) {
                    ...
                    ? _c(
                        ...
                        [
                          _c("input", {
                            ...
                            staticClass: "form-control",
                            attrs: { type: "text", name: "package_count" },
                            domProps: {
                              value:
                ...
                _vm.newItem.item_sections[n - 1]
                  ? _c(
                      ...
                      [
                        ...
                        _vm._v(" "),
                        _vm._l(
                          _vm.newItem.item_sections[n - 1].package_count * 1,
                          function(i) {
                            return _c("div", { staticClass: "form-group" }, [
                              _c("input", {
                                ...
                                on: {
                                  change: function($event) {
                                    return _vm.setTag($event, n - 1, i - 1)
                                  }
                                }
                              })
                            ])
            ...
            _c(
              ...
              [
                _c(
                  ...
                  [_c("i", { staticClass: "hotbox-icon hotbox-icon-c-add" })]
                )
              ]
            ),
            _vm._v(" "),
