            ...
            _c(
              ...
              [
                ...
                _c("form-sectionalobject", {
                  staticClass: "form-group-list mb-4",
                  attrs: {
                    formData: _vm.item.financial_settings,
                    schema: _vm.schema.form.financial_settings,
                    disabled: _vm.$store.getters.userCan("Manage Location")
                      ? false
                      : true,
                    scoped: _vm.item.type
                  ...
                  model: {
                    value: _vm.item.financial_settings,
                    callback: function($$v) {
                      _vm.$set(_vm.item, "financial_settings", $$v)
                    },
                    expression: "item.financial_settings"
                  }
                }),
                _vm._v(" "),
                _vm._m(0),
                  ...
                  _vm.viewPINTab
                    ...
                    : _c(
                        ...
                        [
                          _c("h5", [
                            _vm._v(
                              "This user account does not have the correct permissions to be given an administrative PIN."
                            )
                          ])
                        ]
                      )
