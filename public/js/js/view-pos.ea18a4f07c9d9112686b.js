  ...
  methods: {
    ...
    _calcReturn: function _calcReturn() {
      ...
      this.item.items.reduce(function (amt, im) {
        return amt + im.sale_price * im.quantity_returning;
  ...
  computed: {
    ...
    refund_tax: function refund_tax() {
      return ((this.item || {}).items || []).reduce(function (amt, im) {
        return amt + im.tax * im.quantity_returning;
      }, 0);
    }
  },
  watch: {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    removeOrderItem: function removeOrderItem(id, event) {
      ...
      }); // seems like this is what you would want to do after removing an item
    },
                              ...
                              "discounts" in _vm.order
                                ? _c(
                                    ...
                                    _vm._l(_vm.order.discounts, function(
                                      ...
                                      return !_vm.order.omit_rule_ids.includes(
                                        discount.id
                                      ) &&
                                              ...
                                              _c("div", [
                                                discount.applied.is_active
                                                  ...
                                                  : _c("span", [
                                                      _c("i", {
                                                        staticClass:
                                                          "hide-discount hotbox-icon hotbox-icon-e-remove",
                                                        on: {
                                                          click: function(
                                                            $event
                                                          ) {
