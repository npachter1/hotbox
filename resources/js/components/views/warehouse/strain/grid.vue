    ...
    <div v-if="schema" class="col-12">
        ...
        <transition name="bo-slide">
            <b-table v-if="schema && gridFilters" striped hover                
                ...
                <template v-slot:cell(indica_percentage)="row">
                    {{ row.item.indica_percentage | percentage }}
                </template>

                <template v-slot:cell(sativa_percentage)="row">
                    {{ row.item.sativa_percentage | percentage }}
                </template>
...
<script>
    ...
    import Grid from '../../../../models/Strain';
